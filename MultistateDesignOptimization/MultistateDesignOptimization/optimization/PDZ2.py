...
data = "/netapp/home/tianjiao.zhang/data/PDZrelax.dat";
targetFreqs = "/netapp/home/tianjiao.zhang/data/PDZrelaxTarget.fasta";
...
optimizer.optimize();
now = datetime.now();
optimizer.writeFrequenciesToFASTA(optimizer.getBestFrequencies(), "PDZ2 " + now.strftime('%Y%m%d%H%M%S') + ".fasta");
optimizer.writeBestParamsToText("PDZ2 " + now.strftime('%Y%m%d%H%M%S'));
